...
int	main()
{
  ...
  // SOLEIL GRAVITANT
  PlanetSystem	PlanetR(smgr, driver, "./gfx/particlered.bmp", 800.0f, 0.001f);
  PlanetSystem	PlanetW(smgr, driver, "./gfx/particlewhite.bmp", 600.0f, 0.0009f);
  PlanetSystem	PlanetG(smgr, driver, "./gfx/particlegreen.jpg", 400.0f, 0.0008f);
